...
//$_POST['recipient']               = "libsys@mail.wvu.edu";
...
//$_POST['referers']                = $_SERVER['HTTP_HOST'];
...
//$_POST['replyEmailOnFail']        = "";
//$_POST['replyEmailOnSuccess']     = "";
//$_POST['redirectOnFail']          = "failed.html";
$_POST['useAsAutoResponder']      = true; // default is false - true disables $sender receiving form value email
...
//$_POST['return_link_url']         = "thankyou.html";
//$_POST['return_link_title']       = "Back to Main Page";
//$_POST['missing_fields_redirect'] = "failed.html";
