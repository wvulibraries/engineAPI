...
document.onmousemove = function(ev){
    if (currenttable && currenttable.dragObject) {
        ...
        if (y != currenttable.oldY) {
            ...
            currenttable.dragObject.style.backgroundColor = "#eee"; //WVU Edit
...
document.onmouseup   = function(ev){
    if (currenttable && currenttable.dragObject) {
        ...
        //droppedRow.style.backgroundColor = 'transparent'; //WVU EDIT 
...
function TableDnD() {
    ...
    this.onDrop = function(table, row) {
	    ...
	    for (var i=0; i<rows.length; i++) {
	        debugStr += rows[i].id+" ";
			var positionField = document.getElementById("position_"+rows[i].id);
			positionField.value = i;
	    }
	    //alert('row['+row.id+'] dropped<br>'+debugStr);
    }
